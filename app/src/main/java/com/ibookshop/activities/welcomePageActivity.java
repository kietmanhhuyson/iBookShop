...
public class welcomePageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Find the Google login button in the layout
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            startActivity(intent);
                            finish(); // Đóng welcomePageActivity sau khi chuyển sang MainActivity
                        } else {
                            // Xác thực thất bại, log lỗi để kiểm tra
                            Log.e("FirebaseAuth", "SignInWithCredential:failure", task.getException());
                            Toast.makeText(welcomePageActivity.this, "Đã xảy ra sự cố: " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
